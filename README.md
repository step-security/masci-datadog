...
[![build-test](https://github.com/step-security/masci-datadog/actions/workflows/test.yml/badge.svg)](https://github.com/step-security/masci-datadog/actions/workflows/test.yml)
...
```yaml
- name: Build count
  uses: step-security/masci-datadog@v2
  with:
